            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        else if (x_cord > windowwidth-160) {
                            x_cord = windowwidth-160;
                        }
                        if (y_cord < 240) {
                            y_cord = 240;
                        }
                        else if (y_cord > windowheight-160) {
                            y_cord = windowheight-160;
                        }

                        layoutParams.leftMargin = x_cord-160;
                        layoutParams.topMargin = y_cord-240;
